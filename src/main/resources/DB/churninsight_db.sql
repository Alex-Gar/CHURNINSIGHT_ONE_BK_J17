...
INSERT INTO usuarios (
   id, nombre, p_apellido, s_apellido, email, password, telefono,
   fecha_nacimiento, genero, tiene_conyuge, tiene_dependientes,
   is_enabled, account_no_expired, account_no_locked, credential_no_expired,
   created_at, updated_at, deleted_at
) VALUES
('USR000001', 'Juan', 'Pérez', 'López', 'juan.perez@mail.com', 'hash123', '5512345678',
'1990-05-12', 'Masculino', TRUE, TRUE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000002', 'María', 'García', 'Hernández', 'maria.garcia@mail.com', 'hash123', '5512345679',
'1985-09-20', 'Femenino', TRUE, TRUE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000003', 'Carlos', 'Ramírez', NULL, 'carlos.ramirez@mail.com', 'hash123', '5512345680',
'2003-02-10', 'Masculino', FALSE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2025-11-10 14:30:00'),
('USR000004', 'Ana', 'Martínez', 'Cruz', 'ana.martinez@mail.com', 'hash123', '5512345681',
'1998-11-03', 'Femenino', FALSE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000005', 'Luis', 'Santos', 'Morales', 'luis.santos@mail.com', 'hash123', '5512345682',
'1975-07-28', 'Masculino', TRUE, TRUE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2025-10-01 09:15:00'),
('USR000006', 'Laura', 'Flores', 'Jiménez', 'laura.flores@mail.com', 'hash123', '5512345683',
'2000-01-15', 'Femenino', FALSE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000007', 'Pedro', 'Castillo', 'Vega', 'pedro.castillo@mail.com', 'hash123', '5512345684',
'1988-04-09', 'Masculino', TRUE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2024-12-20 18:45:00'),
('USR000008', 'Sofía', 'Navarro', 'Ruiz', 'sofia.navarro@mail.com', 'hash123', '5512345685',
'1995-12-18', 'Femenino', TRUE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000009', 'Diego', 'Ortega', NULL, 'diego.ortega@mail.com', 'hash123', '5512345686',
'2006-06-01', 'Masculino', FALSE, FALSE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '2025-12-01 12:00:00'),
('USR000010', 'Valeria', 'Mendoza', 'Salinas', 'valeria.mendoza@mail.com', 'hash123', '5512345687',
'1992-03-25', 'Femenino', TRUE, TRUE,
TRUE, TRUE, TRUE, TRUE,
CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
------------------------------------------------------------------------
...
-- Usuarios activos
('USR000001', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL), -- Admin
('USR000002', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000003', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000004', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
-- Usuario con doble rol
('USR000005', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000005', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
-- Roles dados de baja (soft delete)
('USR000006', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('USR000007', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Usuario con rol histórico
('USR000008', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
('USR000009', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
------------------------------------------------------------------------
...
--------------------------------------------
CREATE OR REPLACE VIEW vw_servicios_usuarios AS
SELECT
   u.id AS id_cliente,
   u.genero,
   CASE
       WHEN EXTRACT(YEAR FROM AGE(CURRENT_DATE, u.fecha_nacimiento)) >= 60 THEN 1
       ELSE 0
   END AS adulto,
   u.tiene_conyuge AS tiene_pareja,
   u.tiene_dependientes,
   EXTRACT(YEAR FROM AGE(CURRENT_DATE, u.created_at)) * 12 +
   EXTRACT(MONTH FROM AGE(CURRENT_DATE, u.created_at)) AS antiguedad_meses,
   s.id AS id_servicio,
   s.tipo_contrato,
   ...
   (
       ...
       (
           EXTRACT(YEAR FROM AGE(CURRENT_DATE, u.created_at)) * 12 +
           EXTRACT(MONTH FROM AGE(CURRENT_DATE, u.created_at))
       )
   ) AS cargos_totales,
...
SELECT * FROM vw_servicios_usuarios;

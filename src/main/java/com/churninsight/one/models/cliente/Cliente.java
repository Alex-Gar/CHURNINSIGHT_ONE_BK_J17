...
public class Cliente {
    ...
    private List<Historico> historialChurn;
    ...
    public Cliente(DatosConsultaChurnCliente datos) {
        ...
        this.churn = false;
        this.historialChurn = new ArrayList<>();
        this.activo = true;
    }

    public void actualizar(DatosActualizarCliente datos) {
    ...
    public void actualizarPrediccion(DatosDsPredict datos) {
        this.prevision = datos.prevision();
        this.probabilidad = datos.probabilidad();
        this.churn = datos.churn();
    }
